...
def escape(raw: Any): String = {
  ...
  Literal(Constant(raw)).toString
	...
	def mergeFrom(in: com.google.protobuf2.CodedInputStream, extensionRegistry: com.google.protobuf2.ExtensionRegistryLite): PackageTest = {
...
object PackageTest {
	@scala.beans.BeanProperty val defaultInstance = new PackageTest()
	...
	def parseFrom(byteString: com.google.protobuf2.ByteString): PackageTest = defaultInstance.mergeFrom(byteString)
